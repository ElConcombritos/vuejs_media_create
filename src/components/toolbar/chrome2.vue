<template>
  <div role="application" @click="fuck" aria-label="Chrome color picker" :class="['vc-chrome', disableAlpha ? 'vc-chrome__disable-alpha' : '']">
...
export default {
  ...
  methods: {
    fuck : function () {
      this.$emit("newColor",this.colors.hex)
    },
    childChange (data) {
